...
Route::post('/restore/{type}/{id}', [PurchaseController::class, 'restore']);
Route::delete('/delete/{type}/{id}', [PurchaseController::class, 'destroy']);
Route::delete('/force-delete/{type}/{id}', [PurchaseController::class, 'forceDelete']);
